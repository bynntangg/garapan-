...
<head>
    ...
    <title>Ketentuan Penggunaan - GoCamps</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('terms-of-use') }}">Ketentuan Pengguna</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-lg-10">
                <div class="card content-card">
                    <div class="card-header header-bg text-white">
                        <h2 class="mb-0"><i class="fas fa-clipboard-list me-2"></i>Ketentuan Penggunaan</h2>
                    </div>
                    <div class="card-body">
                        <h4 class="text-primary mt-3">1. Penggunaan Layanan</h4>
                        <p>Dengan menggunakan layanan GoCamps, Anda setuju untuk:</p>
                        <ul>
                            <li>Menyediakan informasi yang akurat dan valid</li>
                            <li>Tidak menyalahgunakan sistem atau layanan kami</li>
                            <li>Mematuhi semua peraturan yang berlaku</li>
                        </ul>

                        <h4 class="text-primary mt-4">2. Pembatalan Pesanan</h4>
                        <ul>
                            <li>Pembatalan lebih dari 24 jam sebelum pengambilan: biaya administrasi 10%</li>
                            <li>Pembatalan kurang dari 24 jam: biaya administrasi 25%</li>
                        </ul>

                        <h4 class="text-primary mt-4">3. Hak Kekayaan Intelektual</h4>
                        <p>Seluruh konten dan materi pada platform GoCamps dilindungi oleh hak cipta.</p>
                    </div>
                </div>
            </div>
        </div>
