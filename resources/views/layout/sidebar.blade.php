        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="widget.html" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Equipment</a>
                    <a href="form.html" class="nav-item nav-link"><i class="fa fa-chart-line me-2"></i>Penjualan</a>
                    <a href="table.html" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Laporan Penjualan</a>
                    <a href="chart.html" class="nav-item nav-link"><i class="fa fa-user me-2"></i>Users</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
