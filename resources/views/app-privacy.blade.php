...
<head>
    ...
    <title>Kebijakan Privasi Aplikasi - GoCamps</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('app-privacy') }}">Kebijakan Privasi Aplikasi</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-lg-10">
                <div class="card content-card">
                    <div class="card-header header-bg text-white">
                        <h2 class="mb-0"><i class="fas fa-mobile-alt me-2"></i>Kebijakan Privasi Aplikasi Booking</h2>
                    </div>
                    <div class="card-body">
                        <h4 class="text-primary mt-3">1. Izin Aplikasi</h4>
                        <p>Aplikasi kami mungkin memerlukan izin berikut:</p>
                        <ul>
                            <li>Penyimpanan (untuk menyimpan data cache)</li>
                            <li>Lokasi (untuk menemukan toko terdekat)</li>
                            <li>Kamera (untuk scan QR code pembayaran)</li>
                        </ul>

                        <h4 class="text-primary mt-4">2. Data yang Dikumpulkan</h4>
                        <p>Aplikasi dapat mengumpulkan:</p>
                        <ul>
                        ...
                        <h4 class="text-primary mt-4">3. Keamanan Data</h4>
                        <p>Kami menggunakan enkripsi untuk melindungi data sensitif dalam aplikasi.</p>
                    </div>
                </div>
            </div>
        </div>
